    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'href' => $this->getUrl('city/city/download/', ['file' => 'zip']),
                'note' => '<br />' . __('Zip codes') . __(
                        'import file will be in csv format and contains two columns like below:'
                    ) . '<br> <table border="1" width="100%"><tr><th>Zipcode</th><th>City</th></tr><tr><td align="center">12345</td><td align="center">Abcd</td></tr></table>
