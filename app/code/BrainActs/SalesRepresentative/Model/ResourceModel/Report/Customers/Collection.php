...
namespace BrainActs\SalesRepresentative\Model\ResourceModel\Report\Customers;
...
class Collection extends \BrainActs\SalesRepresentative\Model\ResourceModel\Report\Collection\AbstractCollection
{
    ...
    public function __construct(
        ...
        $resource->init('brainacts_salesrep_report_customer');
    ...
    protected function _applyAggregatedTable()
    {
        ...
        $mainTable = $this->getTable('brainacts_salesrep_report_customer');
