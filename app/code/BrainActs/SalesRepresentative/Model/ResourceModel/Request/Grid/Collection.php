 ...
 */
namespace BrainActs\SalesRepresentative\Model\ResourceModel\Request\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use BrainActs\SalesRepresentative\Model\ResourceModel\Member\Collection as MemberCollection;
 ...
 */
class Collection extends MemberCollection implements SearchResultInterface
{
    /**
    ...
    protected function _initSelect()
    {
        ...
        $exp = new \Zend_Db_Expr('CONCAT(customerTable.firstname, " ",customerTable.lastname) as customer_name');
