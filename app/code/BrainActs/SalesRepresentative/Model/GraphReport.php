...
class GraphReport
{
     ...
     * @param \BrainActs\SalesRepresentative\Model\ResourceModel\Report\Profit\CollectionFactory $collectionFactory
     ...
     * @return array
     */
    public function prepareReportData($period = '7d', $member = null)
    {
        $report = [];
