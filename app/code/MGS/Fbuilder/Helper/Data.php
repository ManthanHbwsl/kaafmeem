...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function canShowFormLogin(){
		if($this->_fullActionName != 'customer_account_login' && $this->_fullActionName != 'checkout_index_index' && $this->getStoreConfig('themesettings/header/my_account_form')){
			return true;
		}
		return false;
	}
