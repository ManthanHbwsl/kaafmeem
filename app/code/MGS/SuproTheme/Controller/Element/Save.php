			...
			switch ($data['type']) {
				...
				case "tabs":
					if(isset($data['setting']['tabs']) && count($data['setting']['tabs'])>0){
						...
						$dataInit = ['use_slider', 'autoplay', 'stop_auto', 'rtl', 'navigation', 'loop', 'pagination', 'hide_name', 'hide_price', 'hide_addcart', 'hide_addwishlist', 'hide_addcompare', 'tab_ajax', 'tab_font_bold', 'tab_italic', 'tab_uppercase', 'hide_nav'];
						$data = $this->reInitData($data, $dataInit);
