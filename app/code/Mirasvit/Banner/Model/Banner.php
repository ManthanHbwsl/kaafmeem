...
class Banner extends AbstractModel implements BannerInterface
{
    ...
    {
        return explode(',', (string)$this->getData(self::PLACEHOLDER_IDS));
    }
    ...
    {
        return explode(',', (string)$this->getData(self::CUSTOMER_GROUP_IDS));
    }
    ...
    {
        return explode(',', (string)$this->getData(self::STORE_IDS));
    }
