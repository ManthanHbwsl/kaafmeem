...
class Placeholder extends AbstractModel implements PlaceholderInterface
{
    ...
    {
        return (string)$this->getData(self::LAYOUT_POSITION);
    }
    ...
    {
        $arr = explode('/', (string)$this->getLayoutPosition());
    ...
    {
        return $this->setData('additional', SerializeService::encode($additional));
    }
    ...
    public function getAdditional(): ?array
    {
        ...
        return $additional ? SerializeService::decode($additional): null;
    }
}
