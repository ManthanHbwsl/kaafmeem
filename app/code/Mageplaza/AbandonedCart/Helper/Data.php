...
class Data extends AbstractData
{
    ...
    public function getDateRange()
    {
        if ($dateRange = $this->_request->getParam('dateRange')) {
            ...
            list($startDate, $endDate) = $this->getDateTimeRangeFormat($dateRange, 'now');
        }
    ...
    public function getStartDateUTC($from)
    {
        ...
        $startDate      = DateTime::createFromFormat('Y-m-d', $from, $configTimezone);
    ...
    public function getEndDateUTC($toD)
    {
        $configTimezone = new DateTimeZone($this->getTimezone());
        $utcTimezone    = new DateTimeZone('UTC');
        $endDate        = DateTime::createFromFormat('Y-m-d H:i:s', $toD, $configTimezone);
